...
from models import LSTM, IAN, MemNet, RAM, TD_LSTM, Cabasc, ATAE_LSTM, TNet_LF, AOA, MGAN, DLCF_DCA
...
class Instructor:
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(train_data_loader):
                ...
                if global_step % self.opt.log_step == 0:
                    ...
                    logger.info('loss: {:.4f}, acc: {:.4f}'.format(train_loss*100, train_acc*100))

                    val_acc, val_f1 = self._evaluate_acc_f1(val_data_loader)
                    logger.info('> val_acc: {:.4f}, val_f1: {:.4f}'.format(val_acc*100, val_f1*100))
    ...
    def run(self):
        ...
        logger.info('>> test_acc: {:.4f}, test_f1: {:.4f}'.format(test_acc*100, test_f1*100))
...
def main():
    ...
    parser.add_argument('--layer', default=3, type=int, help='set Layers of DCA')
    parser.add_argument('--power', default=1, type=int, help='set power of Gate3')
    parser.add_argument('--use_single_bert', default=True, type=bool, help='use_single_bert')
    ...
    input_colses = {
        ...
        'dlcf_dca': ['text_bert_indices', 'bert_segments_ids', 'text_raw_bert_indices', 'aspect_bert_indices','dep_distance_to_aspect','depend','depended','no_connect','max_dist'],
    }
    initializers = {
